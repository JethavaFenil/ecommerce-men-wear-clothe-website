...
if(isset($_POST["add_product"]))
{
    ...
    $sql="insert into products (id,name,price,product_detail,image) values('$pid','$pname','$pprice','$pdetail', '$image_file')";
        ...
        <div class="container">
            <div class="admin-product-form-container">
               <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                  ...
                  <input type="text" placeholder="enter product detail" name="product_detail" class="box" required>
                  <input type="file" accept="image/png, image/jpeg, image/jpg, image/webp" name="image" class="box" required>
